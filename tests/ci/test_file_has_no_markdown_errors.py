...
def test_file_has_no_markdown_errors(filepath):
    ...
    with subprocess.Popen("pymarkdown -d heading-style,blanks-around-headings,first-line-heading,first-line-h1,MD013,MD036,MD012,MD026,MD033 scan " + filepath,  # noqa: 501 pylint: disable=line-too-long
